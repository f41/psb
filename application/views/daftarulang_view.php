        ...
        <div class="card card-warning card-outline">
          ...
          <div class="card-body">
            ...
            <table id="datatable" class="table table-bordered table-hover text-center">
              ...
              <tbody>
                <?php $no=1; foreach ($pendaftar as $list) { ?>
                <tr>
                  <td><?php echo $no ?>
                  </td>
                  ...
                  <td>
                    <?php $status = $list['dftr_ulang'];
                    if  ($status == null) { ?>
                  	<a href="<?php echo base_url('daftar_ulang/proses/')?><?php echo $list['dftr_nodaftar'] ?>" type="button" class="btn btn-success btn-sm"><i class="fa fa-check">
                    </i>Proses
                    </a>
                    <?php }else{ ?>
                      Sudah Daftar Ulang
